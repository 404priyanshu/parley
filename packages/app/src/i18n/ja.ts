export const dict = {
  ...
  "desktop.recovery.loadFailed": "Parleyを読み込めませんでした",
  "desktop.recovery.terminated": "Parleyのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Parleyが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Parleyのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはParleyがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Parleyのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Parleyが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Parleyで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してParleyで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Parleyで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するParleyサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Parleyを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のParleyを確認中...",
  "wsl.onboarding.updatingOpencode": "Parleyを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のParleyを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のParleyを更新してください。",
  "wsl.onboarding.updateOpencode": "Parleyを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のParleyの準備ができました。",
  "wsl.onboarding.opencodeReady": "Parleyの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にParleyをインストールしてください。",
  "wsl.onboarding.installOpencode": "Parleyをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parleyがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ParleyでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Parleyをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Parleyでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Parleyの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをParleyチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ParleyはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Parleyには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でParleyサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Parleyの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのParleyの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Parleyがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Parleyのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Parley の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Parley は最新バージョンです。",
