export const dict = {
  ...
  "desktop.recovery.loadFailed": "Parley kunde inte läsas in",
  "desktop.recovery.terminated": "Parley-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Parley svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Parley misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Parley-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Parley",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Parley.",
  ...
  "dialog.server.description": "Växla vilken Parley-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Parley i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Parley i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Parley i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Parley i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Parley kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Parley kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Parley igen.",
  ...
  "help.tabs.introduction": "Parley är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Parley ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Parley-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Parley stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Parley innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Parley-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Parley",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Parley ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Parley följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Parleys tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Parley startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Parley.",
