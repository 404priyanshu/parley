export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Parley",
  "desktop.recovery.terminated": "توقفت نافذة Parley بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Parley لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Parley",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Parley، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Parley",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Parley.",
  ...
  "dialog.server.description": "تبديل خادم Parley الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Parley...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Parley في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Parley...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Parley في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Parley في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Parley في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Parley من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Parley التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Parley.",
  ...
  "help.tabs.introduction": "أصبح Parley الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Parley ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Parley",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Parley لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Parley نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Parley داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Parley",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Parley على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Parley يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Parley.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Parley",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Parley.",
