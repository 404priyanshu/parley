export const dict = {
  ...
  "desktop.menu.documentation": "Parley Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Parley.",
  ...
  "desktop.recovery.loadFailed": "Parley no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Parley s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Parley no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Parley ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Parley actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Parley",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Parley.",
  ...
  "dialog.server.description": "Canvia a quin Parley servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Parley...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Parley a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Parley...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Parley a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Parley a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Parley a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Parley pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Parley no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Parley.",
  ...
  "help.tabs.introduction": "Parley L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Parley ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Parley.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Parley encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Parley inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Parley Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Parley dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Parley",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Parley al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Parley segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Parley.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Parley.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Parley.",
