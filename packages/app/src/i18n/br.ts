export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Parley",
  ...
  "desktop.menu.ariaLabel": "Menu do Parley",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Parley",
  "desktop.recovery.terminated": "A janela do Parley foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Parley não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Parley",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Parley não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Parley foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Parley",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Parley.",
  ...
  "dialog.server.description": "Trocar para qual servidor Parley este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Parley em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Parley em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Parley em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Parley",
  "wsl.onboarding.opencodeReadyIn": "O Parley está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Parley está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Parley em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Parley possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Parley não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Parley novamente.",
  ...
  "help.tabs.introduction": "Agora, o Parley é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Parley ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Parley",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Parley ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Parley inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Parley dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Parley",
  ...
  "settings.general.row.appearance.description": "Personalize como o Parley aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Parley segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Parley é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Parley iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Parley.",
