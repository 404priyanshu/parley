...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Parley 載入失敗",
  "desktop.recovery.terminated": "Parley 視窗意外終止",
  "desktop.recovery.unresponsive": "Parley 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "Parley 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Parley",
  "desktop.wsl.error.updateVersion":
    "Parley 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Parley 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Parley 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Parley 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Parley 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Parley 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Parley...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Parley...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Parley 已就緒。",
  "wsl.onboarding.opencodeReady": "Parley 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Parley。",
  "wsl.onboarding.installOpencode": "安裝 Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Parley",
  ...
  "wsl.onboarding.wslUnavailable.description": "Parley 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Parley。",
  ...
  "help.tabs.introduction": "Parley 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Parley 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Parley 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Parley 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "Parley 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Parley 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Parley 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Parley 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Parley 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Parley 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Parley 啟動時自動檢查更新",
