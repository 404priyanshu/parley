...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Parley",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Parley.",
  ...
  "dialog.server.description": "Switch which Parley server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Parley in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Parley in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Parley in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Parley in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Parley can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Parley could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Parley.",
  ...
  "help.tabs.introduction": "Parley is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Parley ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Parley team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Parley does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Parley includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Parley server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Parley",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Parley looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Parley follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Parley is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Parley launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Parley.",
