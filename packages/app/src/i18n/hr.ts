...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Parley se nije uspio učitati",
  "Prozor aplikacije Parley neočekivano je zatvoren",
  "Parley ne reagira",
  ...
  "Instalacija aplikacije Parley nije uspjela",
  ...
  "Parley nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Parley je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Parley",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Parley.",
  ...
  "dialog.server.description": "Promijenite na koji se Parley poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Parley u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Parley u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Parley u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Parley u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Parley",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Parley može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Parley nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Parley.",
  ...
  "help.tabs.introduction": "Radna površina Parley sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Parley ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Parley timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Parley još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Parley uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Parley Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Parley poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Parley",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Parley izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Parley slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Parley tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Parley pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Parley.",
