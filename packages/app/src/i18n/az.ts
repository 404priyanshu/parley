export const dict = {
  ...
  "desktop.recovery.loadFailed": "Parley yüklənə bilmədi",
  "desktop.recovery.terminated": "Parley pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Parley cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Parley quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Parley yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Parley tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Parley-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Parley-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Parley-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Parley serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Parley yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Parley yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Parley yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Parley yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Parley-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Parley-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Parley {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Parley hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Parley-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Parley quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Parley WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Parley bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Parley-u yenidən açın.",
  ...
  "help.tabs.introduction": "Parley indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Parley-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Parley komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Parley hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Parley-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Parley serverini işlət.",
  ...
  "settings.general.row.language.description": "Parley üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Parley-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Parley-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Parley-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Parley açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Parley-un ən son versiyasından istifadə edirsiniz.",
