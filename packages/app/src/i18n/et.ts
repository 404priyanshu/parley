export const dict = {
  ...
  "desktop.recovery.loadFailed": "Parley laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Parley aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Parley ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Parley installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Parley värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Parley",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Parley'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Parley.",
  ...
  "dialog.server.description": "Lülitage, millise Parley serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Parley kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Parley kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Parley värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Parley värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Parley jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Parley asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Parley saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Parley ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Parley.",
  ...
  "help.tabs.introduction": "Parley Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Parley ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Parley meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Parley ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Parley sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Parley Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Parley server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Parley kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Parley teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Parley järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Parley on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Parley käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Parley uusimat versiooni.",
