export const dict = {
  ...
  "desktop.menu.documentation": "Parley Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Parley",
  ...
  "desktop.recovery.loadFailed": "Parley se nepodařilo načíst",
  "desktop.recovery.terminated": "Parley okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Parley nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Parley instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Parley aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Parley.",
  ...
  "dialog.server.description": "Přepněte, ke kterému Parley serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Parley v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Parley v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Parley v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Parley do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Parley může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Parley nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Parley.",
  ...
  "help.tabs.introduction": "Parley Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Parley ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Parley",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Parley zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Parley obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Parley uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Parley",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Parley na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Parley následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Parley.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Parley",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Parley.",
