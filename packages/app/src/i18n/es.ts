export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Parley",
  ...
  "desktop.menu.ariaLabel": "Menú de Parley",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Parley",
  "desktop.recovery.terminated": "La ventana de Parley se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Parley no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Parley",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Parley finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Parley",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Parley.",
  ...
  "dialog.server.description": "Cambiar el servidor de Parley al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Parley en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Parley en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Parley en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Parley en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Parley pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Parley no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Parley.",
  ...
  "help.tabs.introduction": "Parley ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Parley ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Parley",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Parley aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Parley incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Parley dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Parley",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Parley en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Parley sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Parley.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Parley",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Parley.",
