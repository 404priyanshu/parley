export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Parleyn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Parleyssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Parleyssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Parleyssa.",
  ...
  "dialog.server.description": "Vaihda Parley-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Parleya...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Parleya kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Parleya...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Parleya kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Parley jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Parley jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parleya ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Parley voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Parley ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Parley uudelleen.",
  ...
  "toast.update.description": "Parleyn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Parley-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Parley ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Parley sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Parley-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Parleyn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Parley näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Parley järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Parleyn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Parley käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Parleyn uusinta versiota.",
  ...
  "desktop.menu.documentation": "Parley-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Parley-valikko",
  ...
  "desktop.recovery.loadFailed": "Parleyn lataaminen epäonnistui",
  "desktop.recovery.terminated": "Parley-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Parley ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Parleyn asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parleya ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Parleyn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Parley perustuu nyt välilehtiin.",
  "help.tabs.sessions":
