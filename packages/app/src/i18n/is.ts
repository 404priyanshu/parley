...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Parley",
  "Parley-glugganum var óvænt lokað",
  "Parley svarar ekki",
  ...
  "Parley er ekki uppsett í {{distro}}",
  "Uppfærslu Parley lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Parley",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Parley.",
  ...
  "dialog.server.description": "Skiptu um hvaða Parley miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar Parley í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir Parley í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu Parley í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp Parley í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Parley getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Parley gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Parley aftur.",
  ...
  "help.tabs.introduction": "Parley er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Parley ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Parley teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Parley styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Parley inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Parley skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Parley netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Parley",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Parley lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Parley fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Parley er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Parley ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Parley.",
