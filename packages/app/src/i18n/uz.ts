export const dict = {
  ...
  "desktop.menu.documentation": "Parley hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Parley menyusi",
  ...
  "desktop.recovery.loadFailed": "Parley yuklanmadi",
  "desktop.recovery.terminated": "Parley oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Parley javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Parley oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Parley yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Parley tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Parley’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Parley da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Parley da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Parley serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Parley tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Parley {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Parley yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Parley {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Parley-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Parley-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Parley {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Parley tayyor.",
  "wsl.onboarding.installOpencodeIn": "Parley-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Parley-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Parley WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Parley WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Parley-ni qayta oching.",
  ...
  "help.tabs.introduction": "Parley endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Parley ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Parley jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Parley hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Parley bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Parley serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Parley uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Parley qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Parley tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Parley mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Parley ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Parley oxirgi versiyasini ishga tushiryapsiz.",
