export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Parley",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Parley",
  "desktop.recovery.terminated": "Okno Parley zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Parley nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Parley",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Parley została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Parley",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Parley.",
  ...
  "dialog.server.description": "Przełącz serwer Parley, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Parley w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Parley w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Parley w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Parley w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Parley będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Parley nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Parley.",
  ...
  "help.tabs.introduction": "Parley korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Parley ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Parley",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Parley nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Parley zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Parley wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Parley",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Parley na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Parley ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Parley.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Parley",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Parley.",
