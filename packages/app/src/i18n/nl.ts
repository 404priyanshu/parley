export const dict = {
  ...
  "desktop.menu.documentation": "Parley-documentatie",
  ...
  "desktop.recovery.loadFailed": "Parley kan niet worden geladen",
  "desktop.recovery.terminated": "Het Parley-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Parley reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Parley is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Parley-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Parley",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Parley te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Parley te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Parley te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Parley-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Parley controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Parley controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Parley bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Parley bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Parley bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Parley bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Parley is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Parley in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Parley een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Parley kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Parley opnieuw.",
  ...
  "help.tabs.introduction": "Parley is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Parley ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Parley-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Parley ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Parley bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Parley-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Parley",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Parley eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Parley het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Parley aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Parley wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Parley is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Parley.",
