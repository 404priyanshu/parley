export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Parley",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Parley",
  "desktop.recovery.terminated": "La fenêtre Parley s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Parley ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Parley",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Parley est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Parley",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Parley.",
  ...
  "dialog.server.description": "Changez le serveur Parley auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Parley dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Parley dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Parley dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Parley dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Parley puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Parley n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Parley.",
  ...
  "help.tabs.introduction": "Parley s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Parley ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Parley",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Parley ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Parley inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Parley dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Parley",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Parley sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Parley suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Parley.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Parley",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Parley.",
