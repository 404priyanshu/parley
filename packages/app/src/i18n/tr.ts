...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Parley yüklenemedi",
  "desktop.recovery.terminated": "Parley penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Parley yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Parley kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Parley güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Parley tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Parley'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Parley'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Parley'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Parley sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Parley kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Parley kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Parley güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Parley güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Parley'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Parley'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Parley hazır.",
  "wsl.onboarding.opencodeReady": "Parley hazır.",
  "wsl.onboarding.installOpencodeIn": "Parley'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Parley'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Parley'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Parley bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Parley'u tekrar açın.",
  ...
  "help.tabs.introduction": "Parley artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Parley'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Parley ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Parley henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Parley ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Parley Masaüstü",
  ...
  "settings.desktop.wsl.description": "Parley sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Parley'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Parley'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Parley'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Parley'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Parley başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Parley'un en son sürümünü kullanıyorsunuz.",
