export const dict = {
  ...
  "desktop.recovery.loadFailed": "Parley gagal dimuat",
  "desktop.recovery.terminated": "Jendela Parley berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Parley tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Parley gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Parley selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Parley",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Parley.",
  ...
  "dialog.server.description": "Ganti server Parley mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Parley di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Parley di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Parley di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Parley di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Parley dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Parley tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Parley.",
  ...
  "help.tabs.introduction": "Parley kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Parley ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Parley",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Parley belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Parley menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Parley di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Parley",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Parley di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Parley mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Parley diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Parley.",
