...
export const dict = {
  ...
  "desktop.menu.documentation": "Parley-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Parley-meny",
  ...
  "desktop.recovery.loadFailed": "Parley kunne ikke lastes inn",
  "desktop.recovery.terminated": "Parley-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Parley svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Parley mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Parley er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Parley",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Parley.",
  ...
  "dialog.server.description": "Bytt hvilken Parley-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Parley ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Parley-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Parley ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Parley inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Parley-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Parley",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Parley ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Parley skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Parley.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Parley starter",
  ...
  "settings.updates.toast.latest.title": "Parley er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Parley.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Parley i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Parley i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Parley i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Parley i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Parley kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Parley kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Parley på nytt.",
  ...
  "help.tabs.introduction": "Parley er nå bygget rundt faner.",
  "help.tabs.sessions":
