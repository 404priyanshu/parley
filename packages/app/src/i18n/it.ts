export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Parley",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Parley.",
  ...
  "dialog.server.description": "Cambia il server Parley a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Parley in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Parley in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Parley in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Parley in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Parley possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Parley non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Parley.",
  ...
  "help.tabs.introduction": "Parley ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Parley ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Parley",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Parley non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Parley include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Parley all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Parley",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Parley sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Parley segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Parley.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Parley",
  ...
  "settings.updates.toast.latest.title": "Parley è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Parley.",
  ...
  "desktop.menu.documentation": "Documentazione di Parley",
  ...
  "desktop.menu.ariaLabel": "Menu Parley",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Parley",
  "desktop.recovery.terminated": "La finestra di Parley si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Parley non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Parley non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Parley è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
