export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Parley",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Parley.",
  ...
  "dialog.server.description": "Skift hvilken Parley-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Parley i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Parley i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Parley i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Parley kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Parley kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Parley igen.",
  ...
  "toast.update.description": "En ny version af Parley ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Parley-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Parley understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Parley inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Parley-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Parley",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Parley ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Parley skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Parleys tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Parley starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Parley.",
  ...
  "desktop.recovery.loadFailed": "Parley kunne ikke indlæses",
  "desktop.recovery.terminated": "Parley-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Parley mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Parley er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Parley er nu bygget op omkring faner.",
  "help.tabs.sessions":
