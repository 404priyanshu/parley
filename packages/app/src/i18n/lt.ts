...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Parley įkelti nepavyko",
  "Parley langas netikėtai užsidarė",
  "Parley neatsako",
  ...
  "Parley įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Parley neįdiegtas distributyve {{distro}}",
  "Parley naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Parley modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Parley.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Parley serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Parley {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Parley {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Parley {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Parley į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Parley galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Parley nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Parley.",
  ...
  "help.tabs.introduction": "Parley dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Parley ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Parley komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Parley dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Parley apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Parley darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Parley serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Parley ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Parley atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Parley seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Parley temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Parley",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Parley versiją.",
