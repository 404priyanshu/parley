export const dict = {
  ...
  "desktop.menu.documentation": "Документація Parley",
  ...
  "desktop.menu.ariaLabel": "Меню Parley",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Parley",
  "desktop.recovery.terminated": "Роботу вікна Parley несподівано завершено",
  "desktop.recovery.unresponsive": "Parley не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити Parley",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Parley завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Parley",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Parley.",
  ...
  "dialog.server.description": "Перемкніть сервер Parley, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Parley у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Parley у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Parley у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Parley у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Parley потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Parley не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Parley.",
  ...
  "help.tabs.introduction": "Parley тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Parley ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Parley",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Parley ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Parley містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Parley всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Parley",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Parley на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Parley використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Parley.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Parley",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Parley.",
