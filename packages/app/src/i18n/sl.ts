export const dict = {
  ...
  "desktop.menu.documentation": "Parley Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Parley ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Parley se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Parley se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Parley ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Parley je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Parley",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Parley.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Parley se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Parley ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Parley v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Parley ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Parley v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Parley v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Parley v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Parley doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Parley ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Parley.",
  ...
  "help.tabs.introduction": "Parley je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Parley ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Parley",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Parley še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Parley vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Parley znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Parley",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Parley izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Parley sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Parley.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Parley",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Parley.",
