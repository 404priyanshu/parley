export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Parley",
  ...
  "desktop.recovery.loadFailed": "Parley gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Parley ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Parley tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Parley gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Parley selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Parley",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Parley.",
  ...
  "dialog.server.description": "Tukar pelayan Parley yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Parley dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Parley dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Parley dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Parley dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Parley boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Parley tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Parley.",
  ...
  "help.tabs.introduction": "Parley kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Parley ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Parley",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Parley belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Parley merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Parley dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Parley",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Parley pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Parley mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Parley.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Parley dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Parley.",
