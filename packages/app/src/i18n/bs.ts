export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Parley",
  ...
  "desktop.menu.ariaLabel": "Parley meni",
  ...
  "desktop.recovery.loadFailed": "Parley se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Parley-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Parley ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Parley-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Parley-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Parley",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Parley-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Parley-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Parley-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Parley server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Parley u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Parley u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Parley u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Parley u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Parley mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Parley nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Parley.",
  ...
  "help.tabs.introduction": "Parley sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Parley-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Parley timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Parley još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Parley uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Parley server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Parley-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Parley izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Parley prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Parley-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Parley pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Parley-a.",
