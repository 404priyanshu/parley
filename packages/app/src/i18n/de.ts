...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Parley",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Parley zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Parley zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Parley zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Parley-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Parley wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Parley in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Parley wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Parley in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Parley in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Parley aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Parley ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Parley ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Parley in {{distro}}.",
  "wsl.onboarding.installOpencode": "Parley installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Parley einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Parley konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Parley erneut.",
  ...
  "toast.update.description": "Eine neue Version von Parley ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Parley-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Parley unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Parley enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Parley-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Parley ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Parley auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Parley dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Parley anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Parley automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Parley ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Parley wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Parley konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Parley-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Parley reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Parley-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Parley-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Parley basiert jetzt auf Tabs.",
  "help.tabs.sessions":
