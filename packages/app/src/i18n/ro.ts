export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Parley",
  ...
  "desktop.menu.ariaLabel": "Meniu Parley",
  ...
  "desktop.recovery.loadFailed": "Parley nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Parley s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Parley nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Parley a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Parley s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Parley",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Parley.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Parley.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Parley.",
  ...
  "dialog.server.description": "Schimbă serverul Parley la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Parley...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Parley în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Parley...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Parley în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Parley în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Parley",
  "wsl.onboarding.opencodeReadyIn": "Parley este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "Parley este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Parley în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Parley",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Parley să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Parley nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Parley.",
  ...
  "help.tabs.introduction": "Parley este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Parley ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Parley",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Parley nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Parley include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Parley în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Parley",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Parley pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Parley urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Parley.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Parley",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Parley.",
