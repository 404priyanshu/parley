...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Parley failed to load",
  "desktop.recovery.terminated": "Parley window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Parley is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Parley installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Parley is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Parley update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
