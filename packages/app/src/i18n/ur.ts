export const dict = {
  ...
  "desktop.menu.documentation": "Parley دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Parley مینو",
  ...
  "desktop.recovery.loadFailed": "Parley لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Parley ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Parley جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "Parley کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں Parley انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Parley کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "Parley کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Parley میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Parley میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Parley میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Parley سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "Parley چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں Parley چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "Parley کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں Parley کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں Parley کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "Parley کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "Parley {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "Parley تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں Parley انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "Parley انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Parley انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Parley WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Parley اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Parley کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Parley اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Parley ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Parley ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Parley ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Parley میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Parley ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Parley سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Parley کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Parley کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Parley سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Parley کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Parley لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Parley کا تازہ ترین ورژن چلا رہے ہیں۔",
