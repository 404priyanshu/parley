export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Parley. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
