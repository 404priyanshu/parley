export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Parley versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Parley versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
