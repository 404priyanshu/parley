export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Parley. ¿Quieres instalarla y reiniciar?",
