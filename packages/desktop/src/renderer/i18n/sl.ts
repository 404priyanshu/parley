export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} Parley je bila prenesena, jo želite namestiti in znova zagnati?",
