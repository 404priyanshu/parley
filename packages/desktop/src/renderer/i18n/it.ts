export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Parley è stata scaricata. Vuoi installarla e riavviare l'app?",
