export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Parley er lastet ned. Vil du installere den og starte på nytt?",
