export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Parley.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Parley er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
