export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Parley-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Parley-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
