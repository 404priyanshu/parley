export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Parley është shkarkuar, dëshironi ta instaloni dhe rinisni?",
