export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Parley wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
