export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Parley versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
