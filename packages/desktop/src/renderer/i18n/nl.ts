export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Parley is gedownload. Wil je deze installeren en Parley opnieuw starten?",
