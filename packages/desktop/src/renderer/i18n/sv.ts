export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Parley har laddats ned. Vill du installera den och starta om programmet?",
