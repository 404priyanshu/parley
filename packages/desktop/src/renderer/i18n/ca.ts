export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'Parley. Voleu instal·lar-la i reiniciar l'aplicació?",
