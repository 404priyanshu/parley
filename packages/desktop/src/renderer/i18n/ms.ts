export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Parley telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
