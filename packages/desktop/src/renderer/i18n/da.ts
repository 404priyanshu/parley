export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Parley er blevet downloadet. Vil du installere den og genstarte?",
