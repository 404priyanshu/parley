export const dict = {
  ...
  "desktop.updater.none.message": "Parley'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Parley'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
