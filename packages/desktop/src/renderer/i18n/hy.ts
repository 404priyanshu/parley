export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Parley-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Parley-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
