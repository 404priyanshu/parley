export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Parley uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Parley'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
