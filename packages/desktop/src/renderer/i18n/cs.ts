export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Parley",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Parley. Chcete ji nainstalovat a aplikaci znovu spustit?",
